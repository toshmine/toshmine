...
<center> <a href= "https://twitter.com/login?lang=en" draggable="false" target="_blank"><img src="https://i.imgur.com/Qq7cejw.jpg" draggable="false" height="500" width="900"> </a> </center> 
...
There are a lot more things that I learned that make the overall appearances and page look presentable. I had a really challenging, yet fun time figuring out how to do this project. I am mostly done with the assignment, but if you are curious to see how it turned out, here is the link to see the project! <a href=https://lucidity-project-one.glitch.me/Lucidity%20Homepage.html</a>. Yeah, I also leared how to make links clickable! 
